...
if __name__ == "__main__":
    ...
    name_classes    = ["background",'corrosion','steel','crack','corrosion in crack',]
    #-------------------------------------------------------#
    #   指向VOC数据集所在的文件夹
    #   默认指向根目录下的VOC数据集
    #-------------------------------------------------------#
    VOCdevkit_path  = 'gangjin'
    ...
    if miou_mode == 0 or miou_mode == 1:
        ...
        for image_id in tqdm(image_ids):
            ...
            image = A.CLAHE(clip_limit=(4, 4), tile_grid_size=(8, 8), always_apply=True, p=1.0)(image=image)
            image=image['image']
            # image = zca(image)
